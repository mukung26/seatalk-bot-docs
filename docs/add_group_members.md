...
**Source:** https://open.seatalk.io/docs/Add-Group-Members

## API Description

This API allows a bot to invite group members in. 
...
Request Method: `POST`End Point: https://openapi.seatalk.io//messaging/v2/group_chat/add_group_members
...
| employee_codes | string[] | Yes | The list of users invited into the group as a group member. Only users in the bot's service scope can be invited into the group. Regardless of the duplicates, the maximum size will still be 30, and at least 1 member. | N/A | N/A | Refer to request sample below |
...
| success_num | int | The number of employees successfully added to the group |
| error_num | int | The number of employees failed to be added to the group |
| add_failed | []object | List of employees who were failed to be added to the group. Will only be filled in if code = 0 |
| ∟email | string | The email of the employee that was failed to be added |
| ∟employee_code | string | The employee_code of the user who failed to be added to the group |
| ∟error_code | int | Error code of the user who failed to be added to the group |
...
| 4012 | No permission | Ensure that the group owner/admin has allowed members to add/remove members |
...
| 7002 | Group is full | Ensure that there is sufficient space in the group |
| 7005 | User is already in the group | Ensure user added is not a member of the group |
