---
id: get_leave_application_report
title: Get Leave Application Report
category: API Reference
---

# Get Leave Application Report

**Source:** https://open.seatalk.io/docs/hr-application_get-leave-app-report

## API Description

Use this API to obtain employees' leave application records according to a specific date range. 

Note:

- This API requires Get Leave Applications Summary Report permission and the relevant Data Scope

Request Method: `GET`

End Point: https://openapi.seatalk.io/hr/v2/leave/applications
...
| ∟duration | string | The total duration (days) of the leave applied |
...
| ∟applicant_employee_code | string | The employee_code of the leave applicant |
| ∟last_approver_code | string | The last approver's employee_code of the leave application |
| ∟last_action_time | string | The approval date and time when action is done by the last approver |
