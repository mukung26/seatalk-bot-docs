---
id: event__bot_added_to_group_chat
title: Event  Bot Added To Group Chat
category: Events
---

# Event: Bot Added To Group Chat

**Source:** https://open.seatalk.io/docs/event-bot-added-to-group-chat
...
| event_type | string | The type of the event. It will be "bot_added_to_group_chat" in this case |
...
| ∟group_name | string | Group name when the bot is added |
...
| ∟group_settings | object | Current group settings when the bot is added |
| ∟chat_history_for_new_members | string | The extent to which the bot can access the chat histories sent prior to joining. Possible values are "disabled", "1 day" and "7 days". |
...
| ∟inviter | object | |
| ∟seatalk_id | string | The SeaTalk ID of the user who has added the bot to the group chat |
| ∟employee_code | string | The employee_code of the user who has added the bot to the group chat |
